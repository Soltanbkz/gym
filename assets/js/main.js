...
$('.course-bloc').slick({
  ...
  slidesToShow: 4,
  slidesToScroll: 4,
   prevArrow: "<button type='button' class='slick-prev'><i class='dripicons-arrow-thin-left ' aria-hidden='true'></i></button>",
   nextArrow: "<button type='button' class='slick-next'><i class='dripicons-arrow-thin-right' aria-hidden='true'></i></button>",
    responsive: [
    {
      breakpoint: 1024,
      settings: {
